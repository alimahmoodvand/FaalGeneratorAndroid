...
//            ComponentName componentName = new ComponentName("ir.website.faal139", "ir.website.faal139.MainActivity"); // activity which is first time open in manifiest file which is declare as <category android:name="android.intent.category.LAUNCHER" />
...
//            Utility.setLong("removeicon",-1);
    ...
    public static String getPackageName(String filePath) {
        try {
            ...
            Log.d(TAG, "getPackageName: "+ex.getMessage());
            return "";
        }
    }
